...
class ErrorMessages {
  ...
  static const String ERROR_INVALID_EMAIL = "CPF inválido";
  static const String ERROR_CODE_USER_DISABLED = "Usuário não disponível";
  static const String ERROR_CODE_WRONG_PASSWORD = "Senha errada";
  static const String ERROR_CODE_EMAIL_ALREADY_IN_USE = "CPF não disponível";
  static const String ERROR_OPERATION_NOT_ALLOWED = "Operação não disponível";
  static const String ERROR_CODE_WEAK_PASSWORD = "Senha fraca";
  static const String DEFAULT = "Erro";
}
